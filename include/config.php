...
// Bắt đầu cấu hình
$config['basedir']     =  '/home/u741413294/public_html';   //Đường đẫn đến thư mục chứa mã nguồn
$config['baseurl']     =  'http://vaichai.esy.es';   //Liên kết đến thư mục chứa mã nguồn
$config['domain']      =  'vaichai.esy.es';   //Domain của website
$config['license']     =  '15a9bd52-38045634-77d4a4e4-21a221d6';   //Mã đăng ký

$DBTYPE     = 'mysql';
$DBHOST     = 'mysql.hostinger.vn';   //Tên máy chủ cơ sở dữ liệu
$DBUSER     = 'u741413294_admin';   //Tên đăng nhập cơ sở dữ liệu
$DBPASSWORD = '063795126a';   //Mật khẩu kết nối cơ sở dữ liệu
$DBNAME     = 'u741413294_vaidb';   //Tên cơ sở dữ liệu
