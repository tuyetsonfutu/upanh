<?php /* Smarty version 2.6.6, created on 2013-12-22 19:29:05
         compiled from search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'search.tpl', 14, false),array('modifier', 'makeseo', 'search.tpl', 16, false),array('modifier', 'stripslashes', 'search.tpl', 19, false),array('modifier', 'mb_truncate', 'search.tpl', 40, false),array('modifier', 'truncate', 'search.tpl', 40, false),)), $this); ?>
<div id="main">
...
" />
			...
			<br /><?php echo $this->_tpl_vars['total']; ?>
...
/s-error.jpg" alt="Không tìm thấy dữ liệu" />
						...
						<p>
                            <span class="comment"><fb:comments-count href="<?php echo $this->_tpl_vars['baseurl'];  echo $this->_tpl_vars['postfolder'];  echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
/<?php echo ((is_array($_tmp=$this->_tpl_vars['posts'][$this->_sections['i']['index']]['story'])) ? $this->_run_mod_handler('makeseo', true, $_tmp) : smarty_modifier_makeseo($_tmp)); ?>
.html"></fb:comments-count></span>
