...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'makeseo', 'vote.tpl', 5, false),array('modifier', 'stripslashes', 'vote.tpl', 6, false),)), $this); ?>
...
/login">&nbsp;</a>
        ...
        <div id="content" listPage="hot">
			<div class="tips">
				<b>Bạn</b> là người góp phần quyết định những hình ảnh này có được hiển thị ở trang chủ hay không.<br />
				Hãy <b>nhấn</b> vào các nút <span class="like"></span> hoặc <span class="unlike"></span> ở mỗi hình ảnh dưới đây để <b>bình chọn</b> nhé!
			</div>
