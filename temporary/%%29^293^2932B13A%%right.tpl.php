...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'right.tpl', 21, false),array('modifier', 'truncate', 'right.tpl', 26, false),array('modifier', 'makeseo', 'right.tpl', 45, false),array('modifier', 'mb_truncate', 'right.tpl', 96, false),array('insert', 'get_advertisement', 'right.tpl', 67, false),)), $this); ?>
	<div class="side-bar">
    ...
    <script src='themes/jquery.js' type='text/javascript'></script>
		<div class="msg-box notice" style="font-size:12px;">
			<b>Vào Facebook để duyệt sướng hơn! Bạn không vào được? Xem hướng dẫn <a href="http://deuvl.net/fun/cach-vao-facebook-khi-bi-chan-moi-nhat-nam-2014.html">cách vào Facebook 2014</a>.</b>
		</div>
		<div>
...
: <strong><?php echo $this->_tpl_vars['top'][$this->_sections['i']['index']]['points']; ?>
        ...
        <div class="channels">
            <h3><?php echo $this->_tpl_vars['lang272']; ?>
</h3>
			<?php unset($this->_sections['i']);
$this->_sections['i']['name'] = 'i';
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
?>
				<font size=3><a href="<?php echo $this->_tpl_vars['baseurl']; ?>
/channels/<?php echo ((is_array($_tmp=$this->_tpl_vars['c'][$this->_sections['i']['index']]['chname'])) ? $this->_run_mod_handler('makeseo', true, $_tmp) : smarty_modifier_makeseo($_tmp)); ?>
/"><?php echo $this->_tpl_vars['c'][$this->_sections['i']['index']]['chname']; ?>
</a> <b><?php echo $this->_tpl_vars['c'][$this->_sections['i']['index']]['ctotal']; ?>
</b> bài đăng</font><br />
            <?php endfor; endif; ?> 
		</div>
		<?php endif; ?>
